<template>
  <div class="bg-white container mx-auto">
    <Head>
      ...
      <Meta
        name="product_price"
        :content="product1.data.products[0].totalPrice"
      />
      <Meta
        name="product_oldprice"
        :content="product1.data.products[0].price"
      />
      <Meta
        name="availability"
        :content="
          product1.data.products[0].sizes &&
          product1.data.products[0].sizes.length
            ? 'instock'
            : 'outofstock'
        "
      />
    ...
    <div class="pt-6">
        ...
        <div class="md:block hidden">
          ...
          <div class="grid grid-cols-4 gap-4 px-3">
            <div
              ...
              class="group py-2"
            >
              <div @click="() => showImg(i)" class="cursor-pointer">
                <img
                  :src="img"
        ...
        >
          ...
          <div class="mt-5 lg:mt-0 lg:row-span-3">
            ...
            >
              ...
              <span
                class="productDiscount bg-green-300 p-3 rounded-lg mx-3"
                ...
                <div class="text-base text-lg text-gray-900">
                  <ul>
                    ...
                    <li class="mt-4 supportButton">
                      <a
                        target="_blank"
                        href="https://www.instagram.com/annenkovstore/"
      ...
      <section
        v-if="similarProducts.data.products.length > 0"
        class="px-3 mt-10"
      >
        ...
        >
          ...
          >
            ...
            <h3 class="mt-1 text-sm font-semibold text-gray-700"></h3>
...
useHead({
  ...
  charset: 'utf-8',
  meta: [
    { name: 'description', content: `${route.params.title} خرید کفش اورجینال` }
  ]
})
