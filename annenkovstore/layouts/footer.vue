    ...
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="https://annenkovstore.com" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white mx-2 mt-1">آننکوف استور</span>
            </a>
        </div>
        <div class="grid grid-cols-2 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">ما را دنبال کنید</h2>
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline ">اینستاگرام</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">تلگرام</a>
                    </li>
                </ul>
            </div>
            <div>
